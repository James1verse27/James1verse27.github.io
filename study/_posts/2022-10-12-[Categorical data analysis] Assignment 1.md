...
초기값을 *E*(*Y*<sub>*i*</sub>)로 설정하여 돌려본 결과 3번만의 MLE로 잘
추정하는 결과가 나왔다.
...
초기값으로 *β*<sub>1</sub>과 *β*<sub>2</sub>에 어떠한 값을 넣더라도
*β*<sub>1</sub> ≈ 7, *β*<sub>2</sub> ≈ 5되므로

초기값으로*β*<sub>1</sub><sup>(1)</sup> ≈ 7,
*β*<sub>2</sub><sup>(1)</sup> ≈ 5
...
*β̂*<sub>1</sub> = 7.45163, *β̂*<sub>2</sub> = 4.93530
