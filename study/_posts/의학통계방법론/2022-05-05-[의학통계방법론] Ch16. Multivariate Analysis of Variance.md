...
* 다음은은 MANOVA에 대한 검정통계량을 살펴보겠다. <br/><br/>
  - Wilks' lambda (윌크스의 람다)<br/>
    ...
    - 만약 그룹 간 효과와 관련된 B(between)가 커지면 윌크스의 람다 값은 0에 가까워지고 만약 작아지면 1에 가까워진다.<br/>$$ \Lambda=\frac{\mid W \mid }{\mid B+W \mid}=\frac{\mid W \mid}{\mid T \mid}=\prod_{i=1}^{q}\frac{1}{1+\lambda_i} \\ \\ where \ W \ and \ T \ are \ determinants \ of \ the \ within \ and \ total \ sum \ of \ squares \ and \ cross-product \ matrices
$$<br/>
